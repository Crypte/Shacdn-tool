...
export default function Page() {
  ...
  return (
      <div>
          ...
          <InfoBox title="Débutant ? " variant="check">CEX are the best choice if you only want to invest without worrying about storage and security</InfoBox>
