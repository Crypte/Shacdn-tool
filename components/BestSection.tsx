...
export const BestSection = () => {
  ...
  return (
    <div className="md:p-6 p-3 bg-secondary rounded-2xl">
      <div className="mb-14 pt-10 text-center">
        <p className="lg:text-5xl text-3xl font-bold mb-4">Latest Listing </p>
        <p className="text-xl text-muted-foreground">Our latest tool added to the platform</p>
      </div>
      <ToolGrid toolIds={encryption} />
      <div className="flex justify-center mt-8">
      <Button>
      See more<ArrowRightIcon className="ml-2 h-4 w-4" />
      </Button>
      </div>
    </div>
  );
