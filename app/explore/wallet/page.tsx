...
export default function Page() {
  ...
  return (
      <div>
          ...
          <InfoBox title="Custody d'un wallet" variant="warning">La gestion d'un portefeuille nécessite de comprendre les concepts de Seed, de clé publique et de clé privée. Vous êtes votre propre banquier. Si vous n'êtes pas sûr de vous, utilisez un portefeuille pour conserver vos cryptomonnaies.</InfoBox>
